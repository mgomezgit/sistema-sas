...
return [
    ...
    */
    ...
    | líneas. Esto facilita especificar una línea de idioma personalizada
    | para una regla de un atributo determinado.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para reemplazar el marcador de
    | posición del atributo con algo más amigable para el lector, como
    | "Dirección de correo electrónico" en lugar de "email". Esto simplemente
    | ayuda a que nuestro mensaje sea más expresivo.
    |
    */
